...
const ListaPesoAltura = ({ navigation }) => {
    const [clientes, setClientes] = useState([]);

    useEffect(() => {
        axios.get('http://192.168.1.45:8080/clientes/peso-y-altura')
    ...
    return (
        <View>
            <Text>Lista de Clientes con peso mayor a 90 y altura mayor a 1.78:</Text>
            <FlatList
                data={clientes}
...
export default ListaPesoAltura;